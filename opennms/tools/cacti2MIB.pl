...
{   name        => 'Cacti 2 MIB',
    short_names => {
        ...
        'Bytes_sent'                => {mib => 'myBytesSent',                   order => 98,  type => 'Counter32'},
        'Bytes_received'            => {mib => 'myBytesReceived',               order => 99,  type => 'Counter32'},
        ...
        'additional_pool_alloc'     => {mib => 'myAdditionalPoolAlloc',         order => 125, type => 'Gauge32'},
        'total_mem_alloc'           => {mib => 'myTotalMemAlloc',               order => 126, type => 'Gauge32'},
        ...
        'adaptive_hash_memory'      => {mib => 'myAdaptiveHashMemory',          order => 137, type => 'Gauge32'},
        'page_hash_memory'          => {mib => 'myPageHashMemory',              order => 138, type => 'Gauge32'},
        'dictionary_cache_memory'   => {mib => 'myDictionaryCacheMemory',       order => 139, type => 'Gauge32'},
        'file_system_memory'        => {mib => 'myFileSystemMemory',            order => 140, type => 'Gauge32'},
        'lock_system_memory'        => {mib => 'myLockSystemMemory',            order => 141, type => 'Gauge32'},
        'recovery_system_memory'    => {mib => 'myRecoverySystemMemory',        order => 142, type => 'Gauge32'},
        'thread_hash_memory'        => {mib => 'myThreadHashMemory',            order => 143, type => 'Gauge32'},
    },
